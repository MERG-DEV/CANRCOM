...
; DN corruption sorted in this version
...
;	BTFSS		Mode,1				; FLiM?
	...
	MOVWF	DNhi					; 
	CALL		eewrite				; Save it to eeprom 0x00
	INCF		EEADR				; Move to next eeprom entry 0x01
	MOVF		RXB0D4,W			; next byte
	MOVWF	DNlo
	CALL		eewrite				; Save it to eeprom 0x01
...
unlearn:
	...
	CALL		eewrite				; Save it at eeprom address 0x00
	INCF		EEADR				; Move to next eeprom address
	MOVLW	0
	MOVWF	DNlo					; Allocate d'0' to DNlo
	CALL		eewrite				; Save it at eeprom address 0x01				
...
DevNo		DE	0x00,0x01			; Eeprom DN address start point - DNhi = 0x10 & DNlo = 0x11 
